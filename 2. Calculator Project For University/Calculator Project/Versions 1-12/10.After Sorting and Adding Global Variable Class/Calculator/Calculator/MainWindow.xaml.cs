...
namespace Calculator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void BtnLogin_Login_Click(object sender, RoutedEventArgs e)//Log in Process
        {
            //Login Start
            ...
            {
                if (vrLoginUsernameChecking.Split(registerationUsernamePasswordSeparator)[0] == (loggingIn.newLoginUsername))
                {
                    //username exists
                    usernameLoginsuccessful = true;
                    if (vrLoginUsernameChecking == (loggingIn.newLoginUsername + registerationUsernamePasswordSeparator + Encryption.Encode(loggingIn.newLoginPassword)))
                    {
