...
namespace Calculator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void BtnRegister_Register_Click(object sender, RoutedEventArgs e)//Registeration Process
        {
            ...
            if (registeration.newRegisterUsername.Length ==0)
            {
            ...
            //Rule 5 end
            //..............................
            //Rule 6 : Checking if there is already the same username or not
            ...
            if (registeration.newRegisterPassword.Length==0)
            {
            ...
            dicUsers.Add(registeration.newRegisterUsername, Encryption.Encode(registeration.newRegisterPassword));
            LogInProcess();
        ...
        private void BtnLogin_Login_Click(object sender, RoutedEventArgs e)//Log in Processm
        {
            ...
            loggingIn.newLoginUsername = loggingIn.newLoginUsername.Trim().ToLower();
            //Rule 1 End
            //..............................
        ...
        private void Btn_Equal_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Regex.IsMatch(allCalculationsInInputPanel, "[A-Z,a-z]"))
            {
            ...
            catch (System.Data.EvaluateException)//incase something passes
            {
                MessageBox.Show("Error! \n You entered wrong characters in the input panel . Only Numbers , Brackets and Operators.");
                return;
            }
        ...
        public void InputPanelFocus()//Other way to focus 
        {
            txt_InputPanel.Focus();
        ...
        //I have tried to add the functions inside a class but I can't control wpf items without removing static and I can't call functions normally without static (FAILED TRIES FOLDER THAT I SENT YOU) so , I have sorted it like this and I hope it helps you in testing it . I will leave this for next year's Object Oriented Progarmming Lesson.
        //I have started that project in 18-11-2019
        //I have about 13 versions which are the way I developed it 
        //I have about 3 failed versions
        //That's the final and Working one
